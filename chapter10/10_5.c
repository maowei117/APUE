...
int main() {
    ...
    int timer_id1 = create_timer(&context, timer_handler_1, 2);
    int timer_id2 = create_timer(&context, timer_handler_2, 4);
    int timer_id3 = create_timer(&context, timer_handler_3, 6);
    int timer_id4 = create_timer(&context, timer_handler_4, 8);
    int timer_id5 = create_timer(&context, timer_handler_5, 4);
